...
//    }; auto onLeave = [this](const NodeChange& msg) { OnLeave(msg); }; auto onAnnounce =
//    [this](const TopicChange& msg) { OnAnnounce(msg); }; auto onRetract = [this](const
//    TopicChange& msg) { OnRetract(msg); }; auto onSubscribe = [this](const TopicChange& msg) {
//    OnSubscribe(msg); }; auto onUnsubscribe = [this](const TopicChange& msg) { OnUnsubscribe(msg);
//    };
//
//    auto topologyManager = std::make_shared<TopologyManager>(nodeId, groupName, dataPath,
//    nodeName,
//                                                             callbacks, onJoin, onLeave,
//                                                             onAnnounce, onRetract, onSubscribe,
//                                                             onUnsubscribe);
//
